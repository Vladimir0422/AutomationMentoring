...
public class BubbleSorting {
    ...
    public static void main(String[] args) {
        ...
        binarySearch(array, first, last, position, numberForLooking, found);

    }

    public static void binarySearch(int[] array, int first, int last, int position, int numberForLooking, boolean found) {
        int mid;
        while (first <= last) {
            mid = (first + last) / 2;
